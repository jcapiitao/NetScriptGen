...
But it does'nt matter for you, the machine does this without you having to do anything explicit yourself. You can treat Python as a purely interpreted language like the Shell or ```??JavaScript???? Purely interpreted ???```.
...
There are two well-known version of Python which are Python 2 (2.6, 2.7) and Python 3 (3.1, 3.4)
To access the Python 3 interpreter, open a terminal and issue the Unix command ```python3```

.. code-block:: python
   :emphasize-lines: 1,5
   
   jcapitao@SanJose#:~$ python3
