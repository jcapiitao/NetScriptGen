...
Introduction: What is NetScriptGen?
=====================================

NetScriptGen is a Python_ library, which generates script for network equipment. The scripts are generated from parsing an Excel Workbook which contains all the network data, and a global template.  NetScriptGen needs:

- An Excel workbook with all the 
